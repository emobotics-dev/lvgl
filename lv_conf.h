...
#define LV_DISP_DEF_REFR_PERIOD 200      /*[ms]*/

/*Input device read period in milliseconds*/
#define LV_INDEV_DEF_READ_PERIOD 200     /*[ms]*/

/*Use a custom tick source that tells the elapsed time in milliseconds.
 *It removes the need to manually update the tick with `lv_tick_inc()`)*/
#define LV_TICK_CUSTOM 1
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "embassy_timer.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (get_tick_ms())    /*Expression evaluating to current system time in ms*/
...
//#define LV_ATTRIBUTE_LARGE_CONST __attribute__((section(".dram2_uninit")))
